...
#set title image
img = Image.open('diet.png')

st.set_page_config(page_title='Diet Apl', page_icon = img)
...
# Mengatur sidebar
img = Image.open('logooo.png')
st.image(img)
st.sidebar.title("Pilih Tools")
...
#         st.image("")
        ...
        st.write("Total kalori yang anda makan hari ini:", total_kalori) 
